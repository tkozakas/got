...
func (m *mockReminderRepo) Save(ctx context.Context, r *model.Reminder) error { return nil }
...
func (m *mockFactRepo) Save(ctx context.Context, f *model.Fact) error { return nil }
...
func (m *mockStickerRepo) Save(ctx context.Context, s *model.Sticker) error { return nil }
...
func (m *mockSubredditRepo) Save(ctx context.Context, s *model.Subreddit) error { return nil }
...
func (m *mockSubredditRepo) Delete(ctx context.Context, name string, chatID int64) error { return nil }

type mockStatRepo struct{}

func (m *mockStatRepo) Save(ctx context.Context, s *model.Stat) error { return nil }
